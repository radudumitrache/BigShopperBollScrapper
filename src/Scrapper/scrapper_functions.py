...
if __name__ == "__main__":
    url = ("https://www.bol.com/nl/nl/p/sony-official-playstation-5-dualsense-controller/9300000007897748/?bltgh=hv"
           "-IEzy4P-OI9nskywJCaA.2_18.22.ProductTitle")

    # Extract product information
    product_info_dict = get_product_result_dictionary(url)

    if product_info_dict:
        # Print the extracted information
        print("Product Name:", product_info_dict.get("name"))
        print("Product Price:", product_info_dict.get("product_price"))
        print("Country Code:", product_info_dict.get("country_code"))
        print("Product Information:")
        print(json.dumps(product_info_dict.get("product_info"), indent=4))
        print("Other Sellers:")
        print(json.dumps(product_info_dict.get("other_sellers"), indent=4))
    else:
